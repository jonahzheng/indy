...
type
  ...
  public
    ...
    // point it is here.
    procedure GetInternalResponse(const AEncoding: TIdEncoding = enDefault); virtual;
    ...
    function GetResponse(const AAllowedResponse: SmallInt = -1;
      const AEncoding: TIdEncoding = enDefault): SmallInt; overload;
    function GetResponse(const AAllowedResponses: array of SmallInt;
      const AEncoding: TIdEncoding = enDefault): SmallInt; overload; virtual;
    ...
    function GetResponse(const AAllowedResponse: string;
      const AEncoding: TIdEncoding = enDefault): string; overload; virtual;
    //
    ...
    function SendCmd(AOut: string; const AResponse: string;
      const AEncoding: TIdEncoding = enDefault): string; overload;
    //
...
function TIdTCPConnection.GetResponse(const AAllowedResponses: array of SmallInt;
  const AEncoding: TIdEncoding = enDefault): SmallInt;
begin
...
procedure TIdTCPConnection.GetInternalResponse(const AEncoding: TIdEncoding = enDefault);
var
  LLine: string;
