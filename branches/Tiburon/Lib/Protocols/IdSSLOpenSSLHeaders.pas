...
{$ENDIF}
  ...
  OPENSSL_VERSION_NUMBER	= $009080df;
{$IFDEF OPENSSL_FIPS}
  OPENSSL_VERSION_TEXT = 'OpenSSL 0.9.8m-fips 25 Feb 2010'; {Do not localize}
{$ELSE}
  OPENSSL_VERSION_TEXT = 'OpenSSL 0.9.8m 25 Feb 2010';  {Do not localize}
{$ENDIF}
