...
{$ENDIF}
  ...
  OPENSSL_VERSION_NUMBER	= $009080ef;
{$IFDEF OPENSSL_FIPS}
  OPENSSL_VERSION_TEXT	= 'OpenSSL 0.9.8n-fips 24 Mar 2010'; {Do not localize}
{$ELSE}
  OPENSSL_VERSION_TEXT = 'OpenSSL 0.9.8n 24 Mar 2010';  {Do not localize}
{$ENDIF}
