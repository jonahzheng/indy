...
function FindPreferredCharset(const Charset: TIdCharSet): TIdCharSet;
function FindCharset(const s: string): TIdCharset;
function CharsetToCodePage(const Charset: TIdCharSet): Word; overload;
function CharsetToCodePage(const Charset: String): Word; overload;
...
begin
  ...
  for Lcset := Low(TIdCharSet) to High(TIdCharSet) do begin
    if IdCharsetNamesLower[Lcset] = l then begin
      Result := Lcset;
      Break;
    end;
  end;
...
function CharsetToCodePage(const Charset: TIdCharSet): Word;
begin
  Result := IdCharsetCodePages[Charset];
end;

function CharsetToCodePage(const Charset: String): Word; overload;
begin
  Result := CharsetToCodePage(FindCharset(Charset));
end;

procedure InitCharsetNames;
var
  Lcset: TIdCharSet;
begin
  for Lcset := Low(TIdCharSet) to High(TIdCharSet) do begin
    IdCharsetNamesLower[Lcset] := LowerCase(IdCharsetNames[Lcset]);
  end;
end;
