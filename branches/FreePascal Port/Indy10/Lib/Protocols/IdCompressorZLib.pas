...
procedure TIdCompressorZLib.DecompressFTPFromIO(AIOHandler : TIdIOHandler; AOutputStream : TIdStream;
...
procedure TIdCompressorZLib.CompressFTPToIO(AInStream : TIdStream;
...
procedure TIdCompressorZLib.CompressStream(AInStream,AOutStream : TIdStream;
...
procedure TIdCompressorZLib.DecompressStream(AInStream, AOutStream : TIdStream; const AWindowBits : Integer);
begin
  IdZLib.IndyDeCompressStream(AInStream,AOutStream, AWindowBits);
end;    

procedure TIdCompressorZLib.DeflateStream(AInStream, AOutStream : TIdStream; const ALevel : TIdCompressionLevel=0);
begin
  IdZLib.IndyCompressStream(AInStream,AOutStream,ALevel);
end;

procedure TIdCompressorZLib.InflateStream(AInStream, AOutStream : TIdStream);
begin
